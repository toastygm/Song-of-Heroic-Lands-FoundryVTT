...
sohl:
  ...
  attrRollFormula:
    ...
    cre: 1d4+3
  items:
    - { model: attribute-str, system: { scoreBase: 28 } }
    - { model: attribute-end, system: { scoreBase: 21 } }
    ...
    - { model: skill-shok, system: { masteryLevelBase: 84 } }
    - name: Bite
      type: skill
      system:
        shortcode: bite
