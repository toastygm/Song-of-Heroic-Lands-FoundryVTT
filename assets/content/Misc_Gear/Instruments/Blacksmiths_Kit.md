...
A village smith's kit may fit on a packhorse; a master armorer's spans several chests and moves only on a wagon. The tools themselves are not precious — most smiths forge their own hammers and tongs from scrap stock — but the kit as a whole represents years of patient shaping, with each tool true to the hand that made it. A borrowed kit never quite feels right; a stolen one is a curse on the thief, since the stroke is never the same in another smith's hands.
