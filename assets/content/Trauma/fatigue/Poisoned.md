...
- Treat the specific poison — see the poison's own entry
- Purge if recent ingestion; antidote if known and available
- Activated charcoal for ingestion; irrigation for contact poisons
