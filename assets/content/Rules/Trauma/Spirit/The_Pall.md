...
| Result              | Effect                                                                                                                                                                                         |
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **CF0** — Catatonic | Gains **3 Stress Levels**. Unaware and unable to move, act, or defend. A success next turn forces them to flee as if terrified; failure keeps them catatonic and adds 1 SL (retest each turn). |
| **CF5** — Terrified | Gains **2 Stress Levels**. Flees the source at full Move; no Counterstrike defenses. Takes 1 SL per round while still within the Pall. Cleared after ten minutes safe from the source.         |
| **MF** — Disturbed  | Gains **1 Stress Level**. Must move out of the effect, taking 1 SL per round until clear, then cleared.                                                                                        |
| **MS** — Resist     | Immune to all sources of the Pall for one round.                                                                                                                                               |
| **CS** — Immune     | Immune to all sources for ten minutes.                                                                                                                                                         |
